...
namespace {
    raytracer::Point3d makeOrigin(double x, double y, double z)
    {
        return raytracer::Point3d(x, y, z);
    }
...
{
    const raytracer::Point3d origin = makeOrigin(0.0, 0.0, 0.0);
...
{
    const raytracer::Point3d origin = makeOrigin(1.0, 2.0, 3.0);
...
{
    const raytracer::Point3d origin = makeOrigin(5.0, -3.0, 7.0);
    const raytracer::maths::Vector3d direction = makeDirection(1.0, 0.0, 0.0);

    const raytracer::maths::Ray ray(origin, direction);
    const raytracer::Point3d& retrievedOrigin = ray.origin;
...
TEST(RayTest, OriginIsReference)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    const raytracer::Point3d& ref1 = ray.origin;
    const raytracer::Point3d& ref2 = ray.origin;
...
TEST(RayTest, ParametricZeroReturnsOrigin)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(0.0);
...
TEST(RayTest, ParametricPositiveT)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(5.0);
...
TEST(RayTest, ParametricNegativeT)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(-3.0);
...
TEST(RayTest, ParametricWithNonZeroOrigin)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(2.0);
...
TEST(RayTest, ParametricWithFractionalT)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(0.5);
...
{
    const raytracer::Point3d origin = makeOrigin(5.0, 5.0, 5.0);
    const raytracer::maths::Vector3d direction = makeDirection(-1.0, -1.0, -1.0);
...
TEST(RayTest, ParametricWithNonZeroOriginAndDiagonalDirection)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(std::sqrt(3.0));
...
TEST(RayTest, RayAlongYAxis)
{
    ...
    raytracer::Point3d point = ray(7.5);
...
TEST(RayTest, RayAlongZAxis)
{
    ...
    raytracer::Point3d point = ray(4.2);
    EXPECT_DOUBLE_EQ(point.x(), 0.0);
    EXPECT_DOUBLE_EQ(point.y(), 0.0);
...
TEST(RayTest, RayFromCameraScenario)
{
    ...
    const raytracer::Point3d cameraOrigin = makeOrigin(0.0, 0.0, 0.0);
...
TEST(RayTest, ParametricWithVeryLargeT)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(1e10);
...
TEST(RayTest, ParametricWithVerySmallT)
{
    ...
    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(1e-10);
...
{
    const raytracer::Point3d origin = makeOrigin(1e6, 1e6, 1e6);
    const raytracer::maths::Vector3d direction = makeDirection(1.0, 0.0, 0.0);

    const raytracer::maths::Ray ray(origin, direction);
    raytracer::Point3d point = ray(100.0);
